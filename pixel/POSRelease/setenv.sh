...
export BUILD_HOME=/home/cmspixel/TriDAS_Malte
...
export ENV_CMS_TK_ONLINE_ROOT=$BUILD_HOME_FEC/FecSoftwareV3_0
export ENV_CMS_TK_FEC_ROOT=$BUILD_HOME_FEC/FecSoftwareV3_0
...
export LD_LIBRARY_PATH=${BUILD_HOME_FEC}/FecSoftwareV3_0/lib:${LD_LIBRARY_PATH}
