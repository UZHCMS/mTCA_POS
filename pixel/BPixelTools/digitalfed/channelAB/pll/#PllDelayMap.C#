void PllDelayMap(string fileName = "./pll_newFW_ChannelAB_02-09-2016_11:34:08"){ // ROOT scripts always need set of {} to do all the script
	...
	for (int i=0; i<entries; i++)
	{
		...
		if(channelstr == "G"){
			...
			g->SetBinContent(pll400delay+1, pll160delay+1, errorRate);
		}
	}
